...
public class StreamPrompt implements PromptProvider {
    ...
    public StreamPrompt(OutputStream output, InputStream input) {
        this(new PrintWriter(output), input);
    }

    public StreamPrompt(PrintWriter output, InputStream input) {
        this.writer = output;
    ...
    public char[] readSecureLine() {
        throw new UnsupportedOperationException("Secure reads are not supported");
    }
