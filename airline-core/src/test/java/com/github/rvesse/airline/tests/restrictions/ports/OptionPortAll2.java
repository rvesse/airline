...
public class OptionPortAll2 extends OptionPortBase {

    @Option(name = "-p", title = "Port")
    @Port(acceptablePorts = { PortType.OS_ALLOCATED, PortType.SYSTEM, PortType.USER, PortType.DYNAMIC, PortType.ANY })
    public int port;
