...
public class OptionPortAll extends OptionPortBase {

    @Option(name = "-p", title = "Port")
    @Port(acceptablePorts = { PortType.ANY, PortType.OS_ALLOCATED, PortType.SYSTEM, PortType.USER, PortType.DYNAMIC })
    public int port;
