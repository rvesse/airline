...
public class OptionIntegerRangeCompleteExclusive extends OptionRangeBase {
    
    @Option(name = "-i", title = "Integer")
    @LongRange(min = Long.MIN_VALUE, minInclusive = false, max = Long.MAX_VALUE, maxInclusive = false)
    public long i;
}
