 ...
 *            Command type
 */
public class CommandLineInterface<C> {
    ...
    protected final GlobalMetadata<C> metadata;
     ...
     *            CLI class
     */
    public CommandLineInterface(Class<?> cliClass) {
     ...
     *            field
     */
    public CommandLineInterface(Class<?> cliClass, ParserMetadata<C> parserConfig) {
     ...
     *            Global metadata
     */
    public CommandLineInterface(GlobalMetadata<C> metadata) {
        if (metadata == null)
