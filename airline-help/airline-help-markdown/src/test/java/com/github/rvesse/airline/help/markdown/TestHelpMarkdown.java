    ...
    public void user_aliases_help_markdown() throws IOException {
        ...
        Assert.assertEquals(new String(output.toByteArray(), StandardCharsets.UTF_8),
                StringUtils.join(new String[] {
                        ...
                        "`-double` *doub* ] [ `-float` *floa* ] [ `-groups` *groups* ] [ { `-log` |",
                        "`-verbose` } *verbose* ] [ `-long` *l* ] [ `--` ] [ *parameters* ]",
                        "",
                        "# OPTIONS",
                        "",
                        "- `-bigdecimal` *bigd*",
                        ...
                        "",
                        "This CLI supports user defined aliases which may be placed in a test.config",
                        "file located in the following location(s):",
                        "",
                        "1. `target/`",
                        "",
                        "",
                        ...
                        "    b.foo=bar --flag",
                        "",
                        "Here an alias foo is defined which causes the bar command to be invoked with",
                        "the `--flag` option passed to it. Aliases are distinguished from other",
                        "properties in the file by the prefix `b.` as seen in the example.",
                        "",
