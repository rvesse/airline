...
@ExternalExamples(exampleSource = "/com/github/rvesse/airline/help/external/examples.txt", descriptionSource = "/com/github/rvesse/airline/help/external/example-descriptions.txt", sourceLocators = {})
public class ArgsInvalidResourceLocators extends Args1 {
